...
echo "  TTS HQ:    ${API_TTS_QUALITY_MODEL} (mlx-audio, ${TTS_QUALITY_MODEL}, voice=Qwen3 preset, format=${TTS_RESPONSE_FORMAT})"
echo "  TTS VD:    ${API_TTS_VOICE_DESIGN_MODEL} (mlx-audio, ${TTS_VOICE_DESIGN_MODEL}, instruct=required, format=${TTS_RESPONSE_FORMAT})"
